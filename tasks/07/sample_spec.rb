describe LazyMode do
  describe LazyMode::Date do
    ...
    it 'returns the correct year' do
      expect(LazyMode::Date.new('2012-08-07').year).to eq 2012
      expect(LazyMode::Date.new('0712-08-07').year).to eq 712
    end

    it 'returns the correct month' do
      expect(LazyMode::Date.new('2012-08-07').month).to eq 8
      expect(LazyMode::Date.new('2012-12-07').month).to eq 12
    end

    it 'returns the correct day' do
      expect(LazyMode::Date.new('2012-08-07').day).to eq 7
      expect(LazyMode::Date.new('2012-08-17').day).to eq 17
    end

    it 'returns the correct string representation' do
      expect(LazyMode::Date.new('2012-08-07').to_s).to eq '2012-08-07'
      expect(LazyMode::Date.new('0712-18-17').to_s).to eq '0712-18-17'
    end
  end
